...
public class PropertyList extends Canvas {
	...
	public void depopulate() {
		...
		cmp_root.setLayout(new GridLayout(1, false));
		
		CLabel lblTest = new CLabel(cmp_root, SWT.BORDER);
		lblTest.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1));
		lblTest.setText("");
		lblTest.setImage(new Image(null, PropertyList.class.getResourceAsStream("/org/eclipse/swt/controls/collective/PropertyList.Action.png")));
